            ...
            <form>
                <div className="Name">
                    ...
                    <div>
                        ...
                        <input type="text" id="first_name" placeholder="enter your last name" required></input>
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <textarea rows="10" cols="84" placeholder="Send me a message and i will relpy you" id="massage" required></textarea>
                </div>
                <div>
                    <input type="checkbox"></input> you agree to providing your data to name who may contact you
                </div>
                <div>
                    <button type="submit" style={{ width: "98%", backgroundColor: 'blue', color: "white", marginTop: "15px" }}>send message</button>
                </div>
                <div>
                    <a href="/">back home</a>
                </div>
